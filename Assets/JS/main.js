...
TweenMax.from('.home__leaf:nth-child(1)',1.3,{delay: 1.6, opacity: 0, y: -800, ease: Expo.easeInOut})
TweenMax.from('.home__leaf:nth-child(2)',1.4,{delay: 1.6, opacity: 0, y: -800, ease: Expo.easeInOut})
TweenMax.from('.home__leaf:nth-child(3)',1.5,{delay: 1.6, opacity: 0, y: -800, ease: Expo.easeInOut})
TweenMax.from('.home__leaf:nth-child(4)',1.6,{delay: 1.6, opacity: 0, y: -800, ease: Expo.easeInOut})
TweenMax.from('.home__leaf:nth-child(5)',1.7,{delay: 1.6, opacity: 0, y: -800, ease: Expo.easeInOut})
TweenMax.from('.home__leaf:nth-child(6)',1.8,{delay: 1.6, opacity: 0, y: -800, ease: Expo.easeInOut})
